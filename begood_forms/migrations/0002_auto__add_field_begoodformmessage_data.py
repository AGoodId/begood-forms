...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BeGoodFormMessage.data'
        db.add_column(u'begood_forms_begoodformmessage', 'data',
                      self.gf('jsonfield.fields.JSONField')(default={}),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BeGoodFormMessage.data'
        db.delete_column(u'begood_forms_begoodformmessage', 'data')
