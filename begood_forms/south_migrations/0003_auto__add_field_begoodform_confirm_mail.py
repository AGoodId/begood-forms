...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BeGoodForm.confirm_mail'
        db.add_column(u'begood_forms_begoodform', 'confirm_mail',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BeGoodForm.confirm_mail'
        db.delete_column(u'begood_forms_begoodform', 'confirm_mail')
