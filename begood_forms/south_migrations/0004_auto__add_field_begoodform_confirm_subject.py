...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BeGoodForm.confirm_subject'
        db.add_column(u'begood_forms_begoodform', 'confirm_subject',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BeGoodForm.confirm_subject'
        db.delete_column(u'begood_forms_begoodform', 'confirm_subject')
